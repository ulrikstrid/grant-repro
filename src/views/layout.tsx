...
import Provider, { JWKS, SubjectTypes, ResponseType } from "oidc-provider";

const css = `@import url(https://fonts.googleapis.com/css?family=Roboto:400,100);
body {
    ...
    <body>
      <div className="login-card">
        ...
        <div className="login-help">
          <a href={`/interaction/${props.uid}/abort`}>[ Cancel ]</a>
          { props.client.tosUri ?
            <a href={props.client.tosUri}> Terms of Service ]</a>
            : null
          }
          { props.client.policyUri ?
            <a href={props.client.policyUri}>[ Privacy Policy ]</a>
            : null
          }
        </div>
      </div>
      <div className="grant-debug">
        <details>
          <summary style={{textAlign: "center"}}>(Click to expand) DEBUG information</summary>
          <div>
          ...
          <div>
            PARAMS <br />
           ======== <br />
            <div dangerouslySetInnerHTML={{__html: props.dbg.params}} />
          </div>

          <div>
            PROMPT <br />
           ======== <br/>
           <div dangerouslySetInnerHTML={{__html: props.dbg.prompt}} />
          </div>
        </details>
      </div>
    </body>
